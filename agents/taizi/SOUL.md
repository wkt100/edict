...
python3 scripts/kanban_update.py state JJC-xxx Zhongshu "已传达中书省起草"
```

> ⚠️ flow 的 remark 也必须是你自己概括的，不要粘贴皇上原文/文件路径/系统元数据！
> ⚠️ 必须执行 state 命令推进状态，否则旨意将永远卡在太子分拣阶段！
...
python3 scripts/kanban_update.py state JJC-xxx Done "旨意完结"
```
